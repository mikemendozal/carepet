...
@Component({
  selector: 'app-autorizar-cita',
  templateUrl: './autorizar-cita.component.html',
  styleUrls: ['./autorizar-cita.component.css']
})
export class AutorizarCitaComponent implements OnInit {
  ...
  autorizar(appointmen:AppoIntment)
  {
